...
Rein deliberately keeps acquisition and planning stages read-only and gives
...
- Keep secrets out of prompts, run artifacts, and `rein.config.json`.
...
have capabilities outside Rein's control.
