...
> **Decant**, while the verified Skill id remains `decant-spec`.
...
`decant-spec` Skill and contract reference; the baseline was explicitly kept
...
`plugins/decant/skills/decant-spec/evals/cases.json`. The six tuning examples
